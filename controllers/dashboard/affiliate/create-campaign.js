...
module.exports = function(req, res) {
    ...
    `, vars = [
        req.body.code,
        req.session.uid,
        req.session.uid, req.body.promo,
        req.body.promo
    ];
    ...
    db(cn => cn.query(sql, vars, (err, rows) => {
        ...
        if (error) {
            ...
            let sql = `
                ...
                VALUES (?, ?, ?)
            `, vars = [
                req.session.uid, req.body.promo, req.body.code
            ];
            ...
            cn.query(sql, vars, (err, result) => {
                ...
                if (err || !result.affectedRows)
                    ...
                    res.json({ error: false, message: "Campaign created" });
            });
        }
    }));
